/**
 * The React opportunities table, against mocked endpoint responses.
 */
...
describe( 'OpportunitiesTable', () => {
    ...
    it( 'renders the endpoint refusal rather than a blank table', async () => {
        renderTable( { error: 'url_not_monitored', message: 'This installation does not monitor that URL.' }, 403 )

        expect( await screen.findByText( 'These opportunities could not be loaded' ) ).toBeInTheDocument()
    } )
} )
